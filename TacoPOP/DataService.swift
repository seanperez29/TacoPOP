...
class DataService {
    ...
    func loadDeliciousTacoData() {
        ...
        tacoArray.append(Taco(id: 2, productName: "Loaded Cor Chicken Taco", shellId: 2, proteinId: 2, condimentId: 1))
        ...
        tacoArray.append(Taco(id: 9, productName: "Loaded Flour Fish Taco", shellId: 1, proteinId: 4, condimentId: 1))
        tacoArray.append(Taco(id: 10, productName: "Loaded Corn Fish Taco", shellId: 2, proteinId: 4, condimentId: 1))
        tacoArray.append(Taco(id: 11, productName: "Plain Flour Fish Taco", shellId: 1, proteinId: 4, condimentId: 2))
        tacoArray.append(Taco(id: 12, productName: "Plain Corn Fish Taco", shellId: 2, proteinId: 4, condimentId: 2))
